#uSPEC Data Reading and Processing (UNIS Special)
#S.Grant
...
with open(r"C:\Users\stepheg\Downloads\U39_0073.txt") as f: #Enter path for LOG file here <----
   lis = [line.split() for line in f]        

   wl=(lis[37][3])                                                                  #Extract Wavelengths and convert to array
   wlarray=(np.array(wl.split(",")))                                        
   wlarray[0]=wlarray[0].translate({ord('{'): None})
   wlarray[255]=wlarray[255].translate({ord('}'): None})
